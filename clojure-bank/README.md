...
3. Build a Docker image: `sudo docker build -t clojure-bank .`
4. Run your Docker image: `docker run -p 8080:8080 clojure-bank`
...
1. `capstan rmi clojure-bank; capstan build`
